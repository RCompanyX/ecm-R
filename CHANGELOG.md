...
- Added cached editable UTF-8 `translations/en.ini` and `translations/es.ini` bundles with placeholder validation and safe English/compiled-default fallback.
