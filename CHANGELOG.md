...
- Moved canonical movie-muting persistence to `[config]`, removed the obsolete Experimental overlay placement, and updated configuration migration to respect only an existing canonical value while defaulting legacy placements to `true`.
