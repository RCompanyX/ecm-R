...
**Implementation boundary**: This is the separate apply gate. It may modify implementation files only after an explicit `/opsx-apply` request selects a named change or an unambiguous active change. Planning approval and `ARTIFACTS_READY` do not start this workflow.
